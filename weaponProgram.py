...
for record in weapons_file:
    ...
    my_weapon = w.Weapon(name,speed,range_w,)
    ...
    for i in range(my_weapon.get_bullets()):
        ...
        # print out the bullet count every time the weapon is fired
            print('bullets remaining...',my_weapon.get_bullets(),end=''+'\r')
    print()
